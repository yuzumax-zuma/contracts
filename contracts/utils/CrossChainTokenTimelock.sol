...
import "./SafeCrossChainERC20.sol";
 ...
 * after 1 year".
 */
contract CrossChainTokenTimelock {
    using SafeCrossChainERC20 for ICrossChainERC20;

    // ERC20 basic token contract being held
    ICrossChainERC20 private immutable _token;
     ...
     * (in seconds).
     */
    constructor(ICrossChainERC20 token_, address beneficiary_, uint256 releaseTime_) {
     ...
     */
    function token() public view virtual returns (ICrossChainERC20) {
        return _token;
    }
