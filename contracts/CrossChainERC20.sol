...
contract CrossChainERC20 is ERC20, ICrossChainERC20, RouterCrossTalk {
     ...
     * construction.
     */
    constructor(string memory name_, string memory symbol_, address genericHandler_) ERC20(name_, symbol_) RouterCrossTalk(genericHandler_) {}
    ...
    function transferCrossChain(uint8 _chainID, address _recipient, uint256 _amount, uint256 _crossChainGasPrice) public virtual override returns (bool, bytes32) {
     ...
     */
    function _sendCrossChain(uint8 _chainID, address _recipient, uint256 _amount, uint256 _crossChainGasPrice) internal returns (bool, bytes32) {
    ...
    function replayTx(bytes32 hash, uint256 gasLimit, uint256 gasPrice) internal {
